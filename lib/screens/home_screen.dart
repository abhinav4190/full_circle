...
import 'package:full_circle/screens/producer/producer_home_screen.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      // If user is a producer, show the producer-specific home screen
      if (userRole.toLowerCase() == 'producer') {
        return ProducerHomeScreen();
      }
      
      // For other roles (MRF, Recyclers), show the generic home screen
      return _buildGenericHomeScreen(context, userRole);
    });
  }

  Widget _buildGenericHomeScreen(BuildContext context, String userRole) {
